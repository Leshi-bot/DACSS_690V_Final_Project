...
del1Draft = lolliplot5 + labs(title = title_text,
...
map_diff_2021 = map_data_diff %>%
  select(Country.Name, mi2021)
map_diff_2021$year = 2021
map_diff_2021$ratio = (map_diff_2021$mi2021 / map_data_diff$mi1992)
map_diff_2021 = pivot_wider(map_diff_2021,
                        names_from = year,
                        values_from = mi2021)
map_diff_2021 = pivot_longer(map_diff_2021,
                         cols = '2021',
                         names_to = 'year',
                         values_to = 'mileage')

map_data_2021 = merge(global_map, map_diff_2021,
...
del4Draft = base + geom_sf(data = map_data_2021,
                         aes(fill = ratio)) +
